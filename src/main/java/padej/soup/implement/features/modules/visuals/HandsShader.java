...
public class HandsShader extends Module {
   ...
   public HandsShader() {
      ...
      this.setup(modeGroup, dualModeGroup, solidGroup, chromaGroup, balatroGroup, smokeGroup, stripesGroup, snowGroup, glowGroup, glassGroup, invertGroup);
   }
      ...
      if (ShaderHelper.isInitialized()) {
         try {
            ...
            if (this.dualShaderMode.isValue()) {
               ...
               switch (this.mainShader.getSelected()) {
                  case "Solid":
                     this.renderSolid();
                     break;
                  case "Chroma":
            ...
            LoggerUtil.error("Error rendering hand shader: " + e.getMessage());
         }
      }
   }
