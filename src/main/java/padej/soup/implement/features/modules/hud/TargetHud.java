...
public class TargetHud extends Module {
   ...
   public int[] getCustomColors() {
      ...
      return switch (this.particleColorCount.getSelected()) {
   ...
   public TargetHud() {
      ...
      this.setup(appearanceGroup, this.liveTime, displayGroup, positionGroup, particlesGroup, particleColorGroup, networkGroup);
   }
