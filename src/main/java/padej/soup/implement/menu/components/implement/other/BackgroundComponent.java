...
public class BackgroundComponent extends AbstractComponent {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      rectangle.render(
         ShapeProperties.create(context.getMatrices(), this.x + 32.0F, this.y + 28.0F, 1.0, 207.0).color(ColorUtil.getOutline(0.5F, 1.0F)).build()
      );
      rectangle.render(ShapeProperties.create(context.getMatrices(), this.x + 1.0F, this.y + 27.0F, 321.0, 1.0).color(ColorUtil.getOutline(0.5F, 1.0F)).build());
      ...
      String title = MenuScreen.INSTANCE.getCategory().getReadableName();
